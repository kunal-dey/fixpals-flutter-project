...
class CategoryGrid extends StatelessWidget {
  ...
  Container fillGapsInCategory(
    ...
    return Container(
      ...
      child: Center(
        child: Container(
          decoration: BoxDecoration(
              color: cafeAuLait, borderRadius: BorderRadius.circular(10)),
          padding: EdgeInsets.all(
            MediaQuery.of(context).size.width * 0.01,
          ),
          child: Center(child: Text(textToShow, textAlign: TextAlign.center)),
  ...
  Container rowInGrid(BuildContext context, int counter) {
    return Container(
      height: categories.length < 6
          ? MediaQuery.of(context).size.height * 0.3
          : MediaQuery.of(context).size.height * 0.2,
